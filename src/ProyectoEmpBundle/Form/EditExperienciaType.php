...
class EditExperienciaType extends AbstractType {
...
//                 ->add("Borrar Experiencia", SubmitType::class, array("attr" => array(
//                "class" => "form-submit btn btn-success",
//    )))
//                 ->add("Edit Experiencia", SubmitType::class, array("attr" => array(
//                "class" => "form-submit btn btn-success",
//    )))
        ;
    }
